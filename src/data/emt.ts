...
export const SKILLS: EmtSkill[] = [
  { id: "sql-author", name: "SQL authoring", description: "Sherpa writes and validates SQL against your scoped schema.", enabled: true, usedByWorkflows: 2, runs: 188, origin: "prebuilt" },
  { id: "report-writer", name: "Report writer", description: "Turns run output into executive-ready narratives.", enabled: true, usedByWorkflows: 1, runs: 57, origin: "prebuilt" },
  { id: "anomaly-triage", name: "Anomaly triage", description: "Explains spikes and dips in monitored metrics.", enabled: false, usedByWorkflows: 1, runs: 906, origin: "prebuilt" },
  { id: "jira-sync", name: "Jira sync", description: "Files and updates tickets from workflow output.", enabled: false, usedByWorkflows: 0, runs: 0, origin: "prebuilt" },
  { id: "github-summarizer", name: "GitHub summarizer", description: "Condenses commit and PR activity into a briefing.", enabled: true, usedByWorkflows: 1, runs: 34, origin: "prebuilt" },
  { id: "excel-export", name: "Excel export", description: "Builds multi-tab Excel workbooks from tabular run output.", enabled: true, usedByWorkflows: 1, runs: 61, origin: "prebuilt" },
];
