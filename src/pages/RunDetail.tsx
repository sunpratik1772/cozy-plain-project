...
const RunDetail = () => {
  ...
  if (!run) {
    return (
      <AppShell>
        <Seo title="Run not found — EMT Sun" description="This run could not be found." path="/runs" />
  ...
  return (
    <AppShell>
      <Seo title={`${detail.workflowName} run — EMT Sun`} description="Run output detail." path={`/runs/${run.id}`} />
